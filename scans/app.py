...
class Page(tk.Tk):
    ...
    def show_image(self):
        ...
        # open file dialog
        self.path = filedialog.askopenfilename(defaultextension="*.jpg", filetypes = (("JPG", "*.jpg"),("PNG","*.png"),("*.jpeg","*.JPEG")))
    ...
    def ocr(self):
        ...
        ocrtext = tess.image_to_string(Image.open(ofilename),lang='tam')
